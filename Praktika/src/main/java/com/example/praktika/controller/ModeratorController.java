...
public class ModeratorController {
    ...
    private final String apiUrlCategories = "http://api:8088/api/categories";
    private final String apiUrlSponsors = "http://api:8088/api/sponsors";
    private final String apiUrlPlaces = "http://api:8088/api/places";
    private final String apiUrlOrganizers = "http://api:8088/api/organizers";
    private final String apiUrlReviews = "http://api:8088/api/reviews";
    private final String apiUrlEvents = "http://api:8088/api/events";
    private final String apiUrlUsers = "http://api:8088/api/users";
    private final String apiUrlRegistrations = "http://api:8088/api/registrations";
