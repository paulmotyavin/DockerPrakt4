...
public class UserController {
    ...
    private final String apiUrlCategory = "http://api:8088/api/categories";
    private final String apiUrlOrganizer = "http://api:8088/api/organizers";
    private final String apiUrlPlace = "http://api:8088/api/places";
    private final String apiUrlSponsor = "http://api:8088/api/sponsors";
